...
<body>
    ...
    <div id="dokuwiki__site"><div id="dokuwiki__top"
        ...
        <div id="cp_top_tools">
            ...
            <div class="headings">
                <?php
                /*tpl_link(wl(),'<img src="'.ml('cryptopartylogo.png').'" alt="'.$conf['title'].'" />','accesskey="h" title="[H]"')*/
                ?>
        ...
        </div><?php tpl_action('top', 1, 'li') ?></div><!-- /footer -->
